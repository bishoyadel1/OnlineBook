...
{
    [DbContext(typeof(ElectroBookDbContext))]
    partial class ElectroBookDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domin.Entity.ImagesUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ImagesUser", (string)null);
                });
            ...
            modelBuilder.Entity("Domin.Entity.LogCategory", b =>
                {
                    ...
                    b.ToTable("LogCategorys", (string)null);
                });

            modelBuilder.Entity("Domin.Entity.UsersView", b =>
                {
            ...
            modelBuilder.Entity("Domin.Entity.ImagesUser", b =>
                {
                    b.HasOne("Domin.ViewModel.AppUserModel", "AppUserModel")
                        .WithMany("Image")
